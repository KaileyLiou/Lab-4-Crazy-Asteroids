...
This project displays six asteroids moving across the screen, along with a player-controlled spaceship. Each asteroid has a randomized starting position, movement vector, and size. The asteroids wrap around the edges of the screen and bounce off one another when they collide. The player can rotate the spaceship and fire missiles toward the mouse cursor or straight ahead in the direction the ship is facing.
